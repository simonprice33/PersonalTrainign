...
backend:
  ...
  - task: "CORS Configuration Fix"
    ...
    status_history:
        - working: "NA"
          agent: "main"
          comment: "Updated CORS_ORIGINS in .env to explicitly list allowed origins instead of using wildcard '*'. Now includes: http://localhost:3000, https://clientflow-portal-1.preview.emergentagent.com, https://simonprice-pt.co.uk, https://www.simonprice-pt.co.uk. This fixes the 'Not allowed by CORS' error that was blocking client contact form."
        - working: true
          agent: "testing"
